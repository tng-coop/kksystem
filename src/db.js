...
const initializeDb = () => {
  ...
  const seedMembers = [
    { 
      ...
      emergency_address: '東京都渋谷区架空町 1-2-3',
    ...
    { 
      ...
      emergency_address: '神奈川県横浜市架空区 4-5-6',
    ...
    { 
      ...
      emergency_address: '千葉県柏市架空町 7-8-9',
    ...
    { 
      ...
      emergency_address: '東京都世田谷区架空 1-2-3',
